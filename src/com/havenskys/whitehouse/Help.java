...
public class Help extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		body += "<br>This software was written by Haven Skys in Seattle, WA.";
		body += "<br>Doc Chomps is my American Pitbull/Boxer companion.  Super smart, tiger stripped, and more friendly than I am.";
		body += "<br>Support is available via email at <a href=\"mailto:havenskys@gmail.com?Subject='Support Request: "+Custom.APP+"'\">havenskys@gmail.com</a> or through the application's menu system.";
		body += "<h3>Description</h3>\nThis software is intend to provide locally available data while downloading of the data takes place in the background.\n";
